    ...
    <>
      <div className="hero">
        <div className="hero-contents">
          ...
          <p>
            ...
            <Link href="/blog">
              <a className="noselect button purple">Our Articles</a>
            </Link>
          </p>
        </div>
      ...
      <div className="recognitions">
        ...
        <div className="recog-item">
          <a href="https://news24online.com/news/education/experiment-class-12-students-innovation-detect-depression-text-87fffcb4/">
